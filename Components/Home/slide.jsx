      ...
      <div>
        ...
        >
          {products.map((product, index) => (
            ...
            <div className=" flex flex-col justify-center items-center hover:cursor-pointer hover:shadow-lg hover:shadow-black" key={index} onClick={()=>clickListener(product._id)}>
              <img
